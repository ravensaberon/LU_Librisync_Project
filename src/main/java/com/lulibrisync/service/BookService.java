...
public class BookService {
    ...
    /**
     * Generates a unique LU-XXXXXXXX barcode for a book that has no barcode yet,
    ...
    /** Generates a unique LU-XXXXXXXX barcode, retrying on collision (extremely rare). */
    private String generateUniqueBarcode() {
        for (int attempt = 0; attempt < 10; attempt++) {
            // 8 uppercase alphanumeric characters — 36^8 ≈ 2.8 trillion combinations
            String candidate = "LU-" + randomAlphanumeric(8);
